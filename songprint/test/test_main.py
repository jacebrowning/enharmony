...
class TestFind(unittest.TestCase):  # pylint: disable=R0904
    ...
    def test_no_match(self):
        """Verify nothing is returned when no match exists."""
        self.assertEqual(None, find(Title("a"), (Title("b"), Title("c"), Title("d"))))
...
class TestMatch(unittest.TestCase):  # pylint: disable=R0904
    ...
    def test_no_match(self):
        """Verify an empty list is returned when no match exists."""
        self.assertEqual([], match(Title("a"), (Title("b"), Title("c"), Title("d"))))
